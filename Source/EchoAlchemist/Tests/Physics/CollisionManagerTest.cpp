...
bool FCollisionManagerCircleCircleTest::RunTest(const FString& Parameters)
{
	...
	CircleA.ShapeType = ECollisionShapeType::Circle;
	...
	CircleB.ShapeType = ECollisionShapeType::Circle;
...
bool FCollisionManagerCircleRectangleTest::RunTest(const FString& Parameters)
{
	...
	Circle.ShapeType = ECollisionShapeType::Circle;
	Circle.Radius = 10.0f;
	...
	Rectangle.ShapeType = ECollisionShapeType::Rectangle;
...
bool FCollisionManagerPerformanceTest::RunTest(const FString& Parameters)
{
	...
	for (int32 i = 0; i < 50; ++i)
	{
		...
		Body.ShapeType = ECollisionShapeType::Rectangle;
